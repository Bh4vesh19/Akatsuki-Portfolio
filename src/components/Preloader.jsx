...
const Preloader = ({ setLoading }) => {
    ...
    return (
        ...
        >
            ...
            <div className="relative w-full max-w-5xl h-48 md:h-64 flex flex-col justify-end pb-10">



                {/* Running Naruto */}
                <motion.div
                    className="absolute bottom-0 w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 z-50"
                    style={{
                        left: `${progress}%`,
